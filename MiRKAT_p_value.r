...
info = scan(file = info_file, sep='\t', what="character")
DMR = info[1]
case_status = info[2]
dist_mean = info[3]
...
write(c(p_value_permutaion_MiRKAT, DMR, case_status), file = p_val_file, ncolumns = 3, append = TRUE, sep = "\t")
